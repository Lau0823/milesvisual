  ...
  return (
    <main className="bg-[var(--mv-cream)] text-[var(--mv-ink)]">
      ...
      <QuoteModal 
        ...
        planName={activePlan?.nombre || activePlan?.name || 'Pre-Bodas'}
        whatsappUrl={getWhatsappLink(`Hola Miles Visual, quiero cotizar el plan ${activePlan?.nombre || activePlan?.name} de Pre-Bodas`)}
      />
    </main>
  );
}
