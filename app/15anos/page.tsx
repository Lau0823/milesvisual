  ...
  return (
    <main className="bg-[var(--mv-cream)] text-[var(--mv-ink)]">
      ...
      <QuoteModal 
        ...
        planName={activePlan?.nombre || activePlan?.name || '15 Años'}
        whatsappUrl={getWhatsappLink(`Hola Miles Visual, quiero cotizar el plan ${activePlan?.nombre || activePlan?.name} de 15 años`)}
      />
    </main>
  );
}
